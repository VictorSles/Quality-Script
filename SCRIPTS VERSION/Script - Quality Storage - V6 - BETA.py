...
def GetOperationHistoryInfo(session, serial):
    ...
    # O endpoint retorna um dict com uma chave "Wips" que contém uma lista
...
# =======================
# GET INFO BY INJET RESOURCES (MODIFICADA)
# =======================
def GetInfoByInjetResources(session, serial):
    ...
    for idx, inj in enumerate(injet_entries, 1):
        ...
        # 💡 NOVOS CAMPOS SALVOS NO RESULTADO
...
def extract_info(session, serial):
    ...
    # 💡 ESTA FUNÇÃO AGORA RETORNA TAMBÉM OPERATOR E STATUS DO INJET
...
def format_info_line(info, linha, lado, oknok=None, defects=None, link_status=None):
    ...
    # Cria a lista de partes, excluindo WipId
    parts = []
